...
Cette grille présente les compétences professionnelles mobilisées au cours de mon parcours universitaire et professionnel, structurées selon les référentiels métiers de l'**ADBS** (Association des professionnels de l'information et de la documentation) et de l'**AAF** (Association des archivistes français).

Chaque domaine décline trois types de compétences (savoirs, savoir-faire, savoir-être) et renvoie aux **réalisations** qui les illustrent dans la section [Réalisations](../04-realisations/).
...
## 2. Gestion et conservation des collections patrimoniales
...
- Politique documentaire d'un service muséal
...
- Organiser physiquement un espace de stockage documentaire
...
## 3. Médiation, valorisation et accueil des publics
...
- Analyser les pratiques de médiation existantes dans une institution
...
## 4. Outils numériques et compétences transversales
...
- Effectuer une recherche bibliographique avancée (Sudoc, bases spécialisées)
...
## Synthèse : grille de correspondance compétences ↔ réalisations

| Réalisation | Traitement documentaire | Conservation / Gestion | Médiation / Valorisation | Outils numériques |
|---|:---:|:---:|:---:|:---:|
| Dépouillement d'ouvrages et traitement de boîte documentaire | X | X | | |
...
## Sources et référentiels mobilisés

- **ADBS** — [Référentiel métiers des professionnels de l'information et de la documentation](https://adbs.fr/emplois/referentiel-metiers)
- **AAF** — [Référentiel des métiers des archives](https://www.archivistes.org/Referentiel-metiers-et-fiches-de-poste)
- **REME** — Répertoire des métiers de l'enseignement supérieur et de la recherche
- **CNFPT** — Répertoire des métiers de la fonction publique territoriale

➡️ Voir le détail dans la section [Référentiels métiers mobilisés](../05-references-metiers/).
